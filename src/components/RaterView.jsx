      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 py-6">
        <div className="w-full">
          ...
          {!isCheckingRaterType && candidateDetails && vacancyDetails && (
            <div className={`sticky top-8 z-30 bg-gray-100 rounded-xl border border-green-200 overflow-hidden mb-6 shadow-lg transition-all duration-300 ${isModalMinimized ? 'max-h-84' : 'max-h-full'}`}>
