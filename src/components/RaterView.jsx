      ...
      <div className="bg-white shadow-sm border-b border-gray-200">
        <div className="max-w-7xl mx-auto px-6 py-4">
          <div className="text-center">
            ...
            <h1 className="text-2xl font-bold text-gray-900">RHRMPSB Competency Rating System</h1>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 py-6">
        <div className="w-full">
          ...
          {candidateDetails && vacancyDetails && (
            <div className={`sticky top-6 z-30 bg-gray-100 rounded-xl border border-blue-200 overflow-hidden mb-6 shadow-lg transition-all duration-300 ${isModalMinimized ? 'max-h-84' : 'max-h-full'}`}>
              <div className="bg-gradient-to-r from-blue-900 to-blue-700 px-4 py-3 flex justify-between items-center">
