// ─── STARBEIGuideModal.jsx ────────────────────────────────────────────────────
// Fused STAR Method + BEI Interview Guide aligned to DENR CBS Rating Standards
// Replace the existing STARGuideModal in Dashboard.js with this component.
// Usage: import STARBEIGuideModal from './STARBEIGuideModal';
// Render: <STARBEIGuideModal isOpen={starGuideOpen} onClose={() => setStarGuideOpen(false)} />
// ─────────────────────────────────────────────────────────────────────────────
              ...
              <button
                ...
                style={{
                  ...
                  borderBottom: activeTab === tab.id
                    ? `2px solid ${groupColors[tab.group]}`
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: 20 }}>
              ...
              <div style={{ background: '#f8fafc', borderRadius: 12, padding: '16px 18px' }}>
                <h3 style={{ fontSize: 13.5, fontWeight: 800, color: '#1e293b', marginBottom: 10 }}>
                  How to Use STAR–BEI in a CBS Panel Interview
                </h3>
                {[
                  ...
                  <div key={s.letter} style={{ border: `1.5px solid ${open ? s.color : s.borderColor}`, borderRadius: 12, overflow: 'hidden' }}>
                    <button
                      ...
                      style={{
                        ...
                        background: open ? s.lightColor : '#fff',
                    ...
                    >
                      ...
                      <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke={s.color} strokeWidth="2.5" strokeLinecap="round"
              ...
              {[
                {
                  ...
                  tip: 'Never improvise during a CBS BEI. Prepared, standardized questions ensure consistency across all candidates and reduce bias. Deviation from the set questions must be documented.',
                },
                {
...
export default STARBEIGuideModal;
