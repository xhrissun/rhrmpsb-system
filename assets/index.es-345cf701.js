...
import { _ as _typeof$1 } from "./index-f34806de.js";
...
var requireObjectCoercible$b = function(it) {
  if (isNullOrUndefined$3(it))
    throw new $TypeError$f("Can't call method on " + it);
  return it;
};
...
var ordinaryToPrimitive$1 = function(input, pref) {
  var fn, val;
  if (pref === "string" && isCallable$g(fn = input.toString) && !isObject$d(val = call$h(fn, input)))
    return val;
  if (isCallable$g(fn = input.valueOf) && !isObject$d(val = call$h(fn, input)))
    return val;
  if (pref !== "string" && isCallable$g(fn = input.toString) && !isObject$d(val = call$h(fn, input)))
    return val;
...
var toPrimitive$2 = function(input, pref) {
  if (!isObject$c(input) || isSymbol$1(input))
    return input;
  ...
  if (exoticToPrim) {
    ...
    if (!isObject$c(result) || isSymbol$1(result))
      return result;
...
objectGetOwnPropertyDescriptor.f = DESCRIPTORS$9 ? $getOwnPropertyDescriptor$1 : function getOwnPropertyDescriptor(O2, P) {
  ...
  if (hasOwn$9(O2, P))
    return createPropertyDescriptor$2(!call$f(propertyIsEnumerableModule.f, O2, P), O2[P]);
};
...
var defineBuiltIn$7 = function(O2, key, value, options) {
  ...
  if (options.global) {
    ...
    if (simple)
      ...
      definePropertyModule$2.f(O2, key, {
        value,
        enumerable: false,
...
var environment = function() {
  ...
  if (userAgentStartsWith("Node.js/"))
    return "NODE";
  if (globalThis$d.Bun && typeof Bun.version == "string")
    return "BUN";
  if (globalThis$d.Deno && typeof Deno.version == "object")
    return "DENO";
  if (classof$7(globalThis$d.process) === "process")
    return "NODE";
  if (globalThis$d.window && globalThis$d.document)
    return "BROWSER";
  return "REST";
}();
...
var dispatchEvent = function(name, promise2, reason) {
  ...
  if (!NATIVE_PROMISE_REJECTION_EVENT && (handler = globalThis$6["on" + name]))
    handler(event);
...
var promiseResolve$1 = function(C, x) {
  anObject$8(C);
  if (isObject$5(x) && x.constructor === C)
    return x;
...
objectDefineProperties.f = DESCRIPTORS$1 && !V8_PROTOTYPE_DEFINE_BUG ? Object.defineProperties : function defineProperties(O2, Properties) {
  ...
  var key;
  while (length > index2)
    definePropertyModule.f(O2, key = keys3[index2++], props[key]);
  return O2;
};
...
//# sourceMappingURL=index.es-345cf701.js.map
